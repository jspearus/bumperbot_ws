...
void loop() {
  ...
  {
    // old value 385.0 to 1560
    right_wheel_meas_vel = (10 * right_encoder_counter * (60.0/1560.0)) * 0.10472;
    left_wheel_meas_vel = (10 * left_encoder_counter * (60.0/1560.0)) * 0.10472;
